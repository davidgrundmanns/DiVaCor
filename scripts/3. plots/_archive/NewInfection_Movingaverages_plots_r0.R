...
for(i in 1:length(states)){
  ...
  output <- dplyr::select(output, name, date, t_start, t_end, "Mean(R)", "Quantile.0.025(R)","Quantile.0.975(R)", cases, cumcases, mainf, mainf_sd, Einwohnerzahl, infectper, cuminfectper, mainfper, mainfper_sd)
